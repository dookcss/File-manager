...
一个基于PHP开发的现代化Web文件管理系统，具有完整的用户管理、文件存储、分享和API功能，可自行部署至server00。
温馨提示：部署至server00切不可将重要文件放置其中。
...
```
2. **设置子域名或者绑定域名**
此节注意一点Website type选择php
详细设置方法自行搜索

3. **前往文件管理**
将所有文件放置domains/your-domain/public_html

4. **完成安装**
部署完成访问 `http://your-domain/`
